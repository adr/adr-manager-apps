<template>
  <div class="convert" data-cy="convertEditor">
    ...
    <p class="convert-note">
      If you want to use the MADR editor, our parser will generate the Markdown on the right-hand side. You can edit
      your raw Markdown to make sure that no important content is lost while parsing.
    </p>
...
import { DEFAULT_MADR_VERSION, parseRelevantFilesFromMd, parseTagsFromMd } from "@adr-manager/core";
import type { MadrTemplateVersion } from "@adr-manager/core";
import { convertAdr } from "../../src/plugins/parser";
...
function rightDoc(): string {
  return convertAdr(mergeMd, props.templateVersion, {
