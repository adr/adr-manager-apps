...
export function applyFieldVisibilityFilter(
    ...
    return new ArchitecturalDecisionRecord({
        // preserve fields that are never toggleable (maybe lets add status so it does not 
        // mess with search later?)
        yaml: adr.yaml,
        title:adr.title,
        ...
        decisionOutcome: 
        {
            ...
            positiveConsequences: visibility.positiveConsequences 
            ? adr.decisionOutcome.positiveConsequences
                : [],
            negativeConsequences: visibility.negativeConsequences
                ? adr.decisionOutcome.negativeConsequences
                : [],
        },
