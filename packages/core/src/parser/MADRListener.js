...
export default class MADRListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by MADRParser#relevantFiles.
	enterRelevantFiles(ctx) {
	}

	// Exit a parse tree produced by MADRParser#relevantFiles.
	exitRelevantFiles(ctx) {
	}
