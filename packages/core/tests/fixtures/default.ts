// MADR fixtures parsed with core's default options.
// Sourced from the web app's test corpus (apps/adr-manager/tests/constants.ts).
 ...
 */
export const randomStrings: string[] = [
